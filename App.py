...
# Google Generative AI Multimodal Engine
try:
...
# ==============================================================================
# 5. UNIVERSAL FILE & CAMERA CONTENT EXTRACTOR
# ==============================================================================
def extract_text_from_any_file_or_image(file_obj, is_camera=False):
    ...
    # 1. Camera Snapshot or Direct Image Upload
...
def parse_fallback_heuristic(text_clean, default_phase):
    ...
    for line in lines:
        ...
        elif "PHASE 9 PRISM" in l_up or "PRISM" in l_up: current_phase = "DHA Phase 9 Prism"; continue
